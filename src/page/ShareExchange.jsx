    ...
    useEffect(() => {
        const fetchExchangeData = async () => {
            ...
            try {
                ...
                const selectedCard = trade.offeredCards.find(
                    (card) => card.id === selectedCardId
                );

                if (!selectedCard) {
                    throw new Error(
                        "Carte sélectionnée non trouvée dans l'échange"
                    );
                }
                ...
                setError(
                    err.message ||
                        "Une erreur s'est produite lors du chargement des données d'échange"
                );
            } finally {
                setLoading(false);
            }
            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="p-6 bg-blue-500 text-white">
                    <h1 className="text-2xl font-bold">
                        {requester} te propose cet échange
                    </h1>
                    <p className="mt-2 text-blue-100">
                        Utilise ces informations pour effectuer l'échange dans
                        l'application Pokémon TCG Pocket
                    </p>
                </div>
                ...
                <div className="p-6">
                    ...
                    {friendCode && (
                        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-6">
                            ...
                            <div className="flex items-center justify-center sm:justify-start gap-2">
                                <code className="bg-white px-4 py-2 rounded border border-blue-200 font-mono text-lg text-blue-800">
                                    {friendCode}
                                </code>
                                <button
                            ...
                            <p className="text-sm text-blue-600 mt-2">
                                Utilise ce code ami pour trouver {requester}{" "}
                                dans le jeu
                            </p>
                        </div>
                    )}
                    ...
                    <div className="mt-8 p-4 bg-yellow-50 rounded-md border border-yellow-100">
                        ...
                        <ol className="mt-2 ml-6 list-decimal text-sm text-yellow-700 space-y-1">
                            <li>
                                Ouvre l'application Pokémon TCG Pocket sur ton
                                appareil
                            </li>
